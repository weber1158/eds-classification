...
%                               Ti,Cr,Mn,Fe
% "Panta"       Atom percent    F,Na,Mg,Al,Si,P,S,Cl,K,     [4]
%                               Ca,Ti,Cr,Mn,Fe              
%
%EXAMPLES
...
% measurement to the standard spectra in Severin [5] as an additional check
...
%
% [4] Panta , et al. (2023). "Insights into the single-particle composition,
