...
% 
%OUTPUT
% mineral - Struct containing the relevant output for the chosen
%           mineral classification algorithm.
%
%
%NAME-VALUE PAIRS
% NAME
...
if strcmp(algorithm_lowercase,'weber')
 [mineral_list,mineral_groups,probability_scores] = weber_classification(dataTable);
 mineral.Mineral = mineral_list;
 mineral.Group   = mineral_groups;
 mineral.Scores  = probability_scores;

elseif strcmp(algorithm_lowercase,'donarummo')
 mineral_list = donarummo_classification(dataTable);
 mineral.Mineral = mineral_list;

elseif strcmp(algorithm_lowercase,'kandler')
 kandler_table = kandler_classification(dataTable);
 mineral.Class = kandler_table.class;
 mineral.Group = kandler_table.group;
 mineral.RefractiveIndex = kandler_table.refractive_index;

elseif strcmp(algorithm_lowercase,'kutuzov')
 mineral_list = kutuzov_classification(dataTable);
 mineral.Mineral = mineral_list;

elseif strcmp(algorithm_lowercase,'panta')
 mineral_list = panta_classification(dataTable);
 mineral.Mineral = mineral_list;
