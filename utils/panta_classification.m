...
% minerals = PANTA_CLASSIFICATION(data_table, FullNames=false)
%
%INPUT
...
if FullNames
  oldLabels = {'Ab','Alu','Ap','Ca-rich silicate/Ca-Si-mix','Complex clay','Complex Fsp','Complex Fsp/clay mix',...
               ...
               'Ilt','Kln','Mc','Mica','Qz','Rt','Sme','Complex sulfate','Unknown'};
  newLabels = {'Albite','Alunite','Apatite','Ca-rich silicate/Ca-Si-mix','Complex clay',...
               ...
               'Kaolinite','Microcline','Mica','Quartz','Rutile','Smectite',...
			   'Complex Sulfate','Unknown'};
