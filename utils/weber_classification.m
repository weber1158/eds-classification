...
% minerals = WEBER_CLASSIFICATION(data, FullNames=false)
...
%
% FullNames : (Optional, default=true) Set FullNames=false as the second 
%             argument to convert the mineral names to abbreviations. For
%             example, "Albite" will become "Ab".
%
%OUTPUTS
...
%
%See also
% eds_classification, msa_classification, donarummo_classification, kandler_classification, kutuzov_classification, panta_classification
%
%
...
%  July 2026 - Added a FullNames=false name-value pair 
